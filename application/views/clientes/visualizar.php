                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $result->documentoc ?></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $result->celularc ?></td>
                                                </tr>
                                                <tr>
                                ...
                                <div class="collapse accordion-body" id="collapseGThree">
                                    <div class="widget-content">
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    <td style="text-align: right; width: 30%"><strong>Ruac</strong></td>
                                                    <td><?php echo $result->ruac ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: right"><strong>Número</strong></td>
                                                    <td><?php echo $result->numeroc ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: right"><strong>Bairro</strong></td>
                                                    <td><?php echo $result->bairroc ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: right"><strong>Cidade</strong></td>
                                                    <td><?php echo $result->cidadec ?> - <?php echo $result->estadoc ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: right"><strong>CEP</strong></td>
                                                    <td><?php echo $result->cepc ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
