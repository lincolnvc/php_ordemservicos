                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <span style="font-size: 20px; "> <?php echo $emitente[0]->nome; ?></span> </br><span>CNPJ: <?php echo $emitente[0]->cnpj; ?> </br> <?php echo $emitente[0]->rua.', nº:'.$emitente[0]->numero.', '.$emitente[0]->bairro.' - '.$emitente[0]->cidade.' - '.$emitente[0]->uf; ?> </span> </br> <span> E-mail: <?php echo $emitente[0]->email.'  ' ?></span>
                                    
                                     </span> </br> <span> Telefone: <?php echo $emitente[0]->telefone; ?></span>
                                    </td>
                                ...
                                <tr>
                                    <td style="width: 50%; padding-left: 0">
                                        <ul>
                                            <li>
                                                <span><h5>Cliente</h5>
                                                <span><strong>Nome:</strong> <?php echo $result->nomeCliente?></span>  <br/>
                                                <span><strong>Fone:</strong> <?php echo $result->telefonec?></span>  <br/>
                                                <strong>End: <span></strong><?php echo $result->ruac?>, <strong>N°</strong> <span><?php echo $result->numeroc?> - <?php echo $result->bairroc?></span><br/>
                                                <span><?php echo $result->cidadec?> - <?php echo $result->estadoc?></span>
                                            </li>
                                        </ul>
                                    </td>
                                    <td style="width: 50%; padding-left: 0">
                                        <ul>
                                            <li>
                                                ...
                                                <span><strong>Telefone</strong>: <?php echo $result->telefone?></span><br/>
                                                <span><strong>Email:</strong> <?php echo $result->email?></span>
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
