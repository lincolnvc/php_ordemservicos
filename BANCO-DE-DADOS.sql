...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `documentoc` VARCHAR(20) NOT NULL,
  `telefonec` VARCHAR(20) NOT NULL,
  `celularc` VARCHAR(20) NULL DEFAULT NULL,
  `emailc` VARCHAR(100) NOT NULL,
  `dataCadastro` DATE NULL DEFAULT NULL,
  `ruac` VARCHAR(70) NULL DEFAULT NULL,
  `numeroc` VARCHAR(15) NULL DEFAULT NULL,
  `bairroc` VARCHAR(45) NULL DEFAULT NULL,
  `cidadec` VARCHAR(45) NULL DEFAULT NULL,
  `estadoc` VARCHAR(20) NULL DEFAULT NULL,
  `cepc` VARCHAR(20) NULL DEFAULT NULL,
